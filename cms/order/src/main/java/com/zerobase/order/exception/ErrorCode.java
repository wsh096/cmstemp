...
public enum ErrorCode {
    ...
    CARD_CHANGE_FAIL(HttpStatus.BAD_REQUEST, "장바구니에 추가할 수 없습니다."),
    ITEM_COUNT_NOT_ENOUGH(HttpStatus.BAD_REQUEST, "상품의 수량이 부족합니다."),

    ORDER_FAIL_CHECK_CART(HttpStatus.BAD_REQUEST, "주문 불가 장보구니를 확인해주세요."),
    ORDER_FAIL_BALANCE_PROBLEM(HttpStatus.BAD_REQUEST, "주문 불가 잔액을 확인해주세요."),
